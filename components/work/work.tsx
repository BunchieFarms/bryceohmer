    ...
    return (
        <div style={{ marginTop: "1rem" }}>
            <Typography variant="h4">
                CentralSquare Technologies (2021-)
            </Typography>
            ...
            <Typography paragraph>One of the most important things I learned about Agile is that there will always be someone there to tell you that you are doing Agile wrong.</Typography>
            <Typography paragraph>
            ...
            <Typography paragraph>
                ...
                This job reminded me how little I knew and forced me to challenge myself and grow as a developer.</b>
            </Typography>
            ...
            <Typography paragraph>
                ...
                I was able to meet with stakeholders, head meetings with customers, and run trainings for the people using our software.
                I worked with some very smart people that took me from a dingbat who knew nothing to a fairly competent developer.
            </Typography>
            <Typography paragraph>
                In my time here, I mostly worked with <b>Angular, .Net Core, and SQL Server</b>. I was also tasked with converting our web API to use <b>GraphQL</b>, which was a fun challenge.
            </Typography>
        </div>
    )
}